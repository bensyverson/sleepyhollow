...
struct SleepyCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [LoadCommand.self, ShotCommand.self, PdfCommand.self, ArchiveCommand.self, DomCommand.self, QueryCommand.self, StyleCommand.self, FindCommand.self, AXCommand.self, ContrastCommand.self, OverflowCommand.self, ConsoleCommand.self, WireCommand.self, EvalCommand.self, ClickCommand.self, FillCommand.self, SubmitCommand.self, OpenCommand.self, CloseCommand.self, SessionsCommand.self, JarsCommand.self, CookiesCommand.self, RecipesCommand.self, DoctorCommand.self, HostCommand.self],
    )
